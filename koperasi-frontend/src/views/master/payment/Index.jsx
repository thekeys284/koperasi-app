...
const PaymentPage = () => {
    ...
    const handleAdd = () => {
        navigate('/master/payment-methods/add');
    };

    const handleEdit = (id) => {
        console.log("Edit payment method ID:", id);
        navigate(`/master/payment-methods/edit/${id}`);
    };
    const handleDelete = async () => {
            try {
                await api.delete(`/payment-methods/${selectedId}`);
    ...
    return (
        <MainCard title="Daftar Metode Pembayaran">
