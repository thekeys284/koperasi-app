type Assign<A, B> = { [K in keyof A | keyof B]: K extends keyof A ? K extends keyof B ? NonNullable<A[K]> extends ((...args: any[]) => any) ? NonNullable<B[K]> extends ((...args: any[]) => any) ? A[K] | B[K] : B[K] : B[K] : A[K] : K extends keyof B ? B[K] : never };
...
export {};
//# sourceMappingURL=chainEventHandlers.d.mts.map